...
<?php include("includes/typekit.php");?> 
    ...
    <meta property="og:url" content="<?php echo base_url();?>article/view/<?php echo $post[0]->Post_Slug; ?>" />
...
<div id="profileWidget" data-influencer="29102813">
    ...
    <div id="profileDetails" >
            ...
            <div id="aboutMe" class=""<?php /*?> style="border-bottom:1px solid #999;"<?php */?>>
                ...
                <?php
                if(isset($post[0]->Author_Name)){
				?>
				<a href="<?php echo base_url();?>author/view/<?php echo $post[0]->Author_Slug; ?>"><?php echo $post[0]->Author_Name; ?></a>:
                <?php
				}else{
				?>
