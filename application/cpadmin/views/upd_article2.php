...
/*----------------------------------------------------------------------------------*/
                                    ...
                                    <div class="button-box">
                                   	  <input type="submit" name="button" id="proceed_button" value="Update and Continue" class="st-button" />
                                      <script>$(function(){
                                      $("#proceed_button").click(function(){$(location).attr('href', '<?php echo base_url();?>article/proceed_upd_step3/<?php echo $id;?>');});
                                      })</script>
                                    </div>
