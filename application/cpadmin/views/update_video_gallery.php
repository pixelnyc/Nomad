                                ...
                                <div class="body">
                                 ...
                                 <?php echo form_open('article/submit_gallery_step1'); ?>
                                  	...
                                  	<div class="st-form-line">	
                                        ...
                                        <input name="author_name" type="text" class="st-forminput  tips-right" id="author_name" style="width:300px" original-title="Enter Author Name" value="<?php echo $gallery_data[0]->Post_Author;?>" /> 
                                    <div class="clear"></div>
                                    </div>
                                    ...
                                    <div class="st-form-line">	
                                        ...
                                        <input name="headline" type="text" class="st-forminput tips-right" id="headline" style="width:510px" original-title="Enter Headline" value="<?php echo $gallery_data[0]->Post_Headline;?>" /> 
                                    <div class="clear"></div>
                                    </div>
									...
									<div class="st-form-line" style="z-index: 480;">	
                                        ...
                                        <textarea name="byline" class="st-forminput tips-right" id="wysiwyg" style="width:510px" rows="3" cols="47" original-title="Enter Byline"><?php echo $gallery_data[0]->Post_Byline;?></textarea> 
                                        </div>
                                    ...
                                    <!-- This is uniform selectbox - view this item class -->
                                  	<div class="st-form-line">	<span class="st-labeltext">Section</span>	
                                   	<select name="section" id="section" class="uniform">
                                        ...
                                        <?php
                                        if($gallery_data[0]->Cat_Id == $section['Cat_Id']){$select="SELECTED";}else{$select="";}
										?>
									...
									<div class="st-form-line">	
                                        ...
                                        <input name="photographer_name" type="text" class="st-forminput  tips-right" id="photographer_name" style="width:300px" original-title="Enter Photographer Name" value="<?php echo $gallery_data[0]->Photographer_Name;?>" /> 
                                    <div class="clear"></div>
                                    </div>    
                                    ...
                                    <div class="st-form-line">	
                                        ...
                                        <input name="photographer_gps_code" type="text" class="st-forminput  tips-right" id="photographer_gps_code" style="width:300px" original-title="Enter Photographer's GPS Code" value="<?php echo $gallery_data[0]->Photographer_Gps;?>" /> 
                                    <div class="clear"></div>
                                    </div>
...
<?php /*?>                                      <input type="hidden" name="post_type" id="post_type" value="<?php echo $post_type; ?>" class="st-clear"/>
                                      <input type="hidden" name="gallery_type" id="gallery_type" value="<?php echo $gallery_type; ?>" class="st-clear"/><?php */?>
                                    </div>
