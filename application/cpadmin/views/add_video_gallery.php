        ...
        <div id="page">
                ...
                <div class="page-title">
                	<div class="in">
                            ...
                            <h2>ADD Video Gallery</h2>	<p>Create New Video gallery :)</p>
                            </div>
                                ...
                                <div class="body">
                                 ...
                                 <?php echo form_open('article/submit_gallery_step1'); ?>
									...
									<div class="st-form-line" style="z-index: 480;">	
                                        ...
                                        <textarea name="byline" class="st-forminput tips-right" id="wysiwyg" style="width:510px" rows="3" cols="47" original-title="Enter Byline"></textarea> 
                                        </div>
