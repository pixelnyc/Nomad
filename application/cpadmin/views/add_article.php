...
<?php include("templates/side_bar.php");?>
        ...
        <div id="page">
                ...
                <div class="page-title">
                	<div class="in">
                    		<div class="titlebar">	
                            <h2>ADD ARTICLE</h2>	<p>Create New Article :)</p>
                            </div>
                    ...
                    <div class="content">
                        	...
                        	<div class="simplebox grid740">
                                ...
                                <div class="body">
                                 ...
                                 <?php echo form_open('article/submit_art_step1'); ?>
...
<?php /*?>                                  	<div class="st-form-line">	
                                    ...
                                    <input name="author_name" type="hidden" class="st-forminput  tips-right" id="author_name" style="width:300px" original-title="Enter Author Name" />
