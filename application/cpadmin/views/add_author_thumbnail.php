...
<?php include("templates/side_bar.php");?>
        ...
        <div id="page">
                ...
                <div class="page-title">
                	<div class="in">
                    		<div class="titlebar">	<h2>ADD AUTHOR PICTURE</h2></div>
...
var settings = {
	url: "<?php echo base_url();?>jquery-multiple-file-upload/upload-author-pic.php",
	method: "POST",
	allowedTypes:"jpg,png,gif,jpeg",
	fileName: "author_thumb_file",
	multiple: false,
...
$("#single-fileuploader-1").uploadFile(settings);
                                    ...
                                    <div class="button-box">
                                      ...
                                      <script>
									  $(function(){
                                      $("#proceed_button").click(function(){$(location).attr('href', '<?php echo base_url();?>author/author_list');});
                                      })
                                      </script>  
